...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int initialBalance, int? iconCodePoint});
}
...
class _$WalletImpl implements _Wallet {
  ...
  @override
  String toString() {
    return 'Wallet(id: $id, name: $name, initialBalance: $initialBalance, iconCodePoint: $iconCodePoint)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, initialBalance, iconCodePoint);
...
abstract class _Wallet implements Wallet {
  const factory _Wallet(
      ...
      final int? iconCodePoint}) = _$WalletImpl;
