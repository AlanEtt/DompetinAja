...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, CategoryType type, int? iconCodePoint});
}
...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, type: $type, iconCodePoint: $iconCodePoint)';
  }
...
abstract class _Category implements Category {
  const factory _Category(
      ...
      final int? iconCodePoint}) = _$CategoryImpl;
